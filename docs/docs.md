...
A: Most restaurants open at 6am and close at 11pm, though hours vary by location — many drive-thrus and McDelivery are open 24 hours. Check the app or website for your local restaurant's exact hours.
...
A: Yes, delivery is available through the app as well as through delivery partners like Uber Eats, DoorDash, and Grubhub, depending on your location.

Q: What is your refund policy for a wrong or missing order?
A: If your order was wrong, missing items, or never arrived, let us know through this chat and we'll log a case and can connect you with a team member — refunds or replacements are handled case by case depending on how you ordered (in-restaurant, app, or delivery partner).

Q: How do I contact a specific restaurant directly?
A: You can find the phone number and address for your local restaurant using the restaurant locator in the app or on our website.

Q: How do I give feedback about my visit?
A: You can tell me directly in this chat — whether something went great or didn't meet expectations, I'll log your feedback so we can keep improving.
